...
export const SECTION_TOOLTIPS: Record<string, string> = {
  ...
  "phase.cliRequirements": "CLI 기능·비기능 요구사항 + 실행 환경, 배포 채널, 안전성·성능 SLO를 정의하세요.",
  "phase.commandTree": "루트 바이너리, 서브커맨드, 플래그, positional, 컨벤션을 설계하세요.",
  "phase.cliContract": "각 커맨드의 stdin/stdout/stderr/exit code 계약과 human·agent 샘플을 명세하세요.",
  "phase.cliConfig": "XDG 경로, 설정 파일, 환경 변수, 시크릿 전략, --json 출력 스키마를 정의하세요.",
  "phase.cliTerminalUx": "ANSI 팔레트, --help 템플릿, 에러 메시지, UX 라이팅 + AI 에이전트 친화도를 설계하세요.",
