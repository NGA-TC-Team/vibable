...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-background font-sans text-foreground">
      <main className="relative flex flex-1 w-full max-w-3xl flex-col items-center justify-between gap-8 py-24 px-8 sm:px-16 sm:items-start">
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          <a
            className="flex h-12 w-full items-center justify-center rounded-full border border-border bg-background px-5 transition-colors hover:bg-muted md:w-[158px]"
